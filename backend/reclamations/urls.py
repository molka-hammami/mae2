...
urlpatterns = [
    ...
    path("reclamations/<int:pk>/admin-note/", views.update_admin_note, name="update_admin_note"),
    path(
    "reclamations/<int:pk>/internal-note/",
    views.update_internal_note,
    name="update_internal_note",
),
path("reclamations/<int:pk>/internal-note/", views.update_internal_note),
path("reclamations/<int:pk>/mark-processed/", views.mark_as_processed),
path(
